<template>
  <div class="container">
    ...
    <p>你可以进入我们的 <a href="https://test.losernft.org">测试网页</a> 帮助我们测试新功能。点击右上角的按钮，然后下拉选择“查看持有的NFT”。如果你没有测试网的BNB，可以点击“<a href="https://testnet.binance.org/faucet-smart">Testnet Funds</a>”链接获取一些BNB进行测试，然后点击下方的“申请”按钮就可以领取一些Lowb进行测试了。</p>
  </div>
</template>
